...
import { getSucheAlleBuecher, setSucheAlleBuecher, getSucheBuchID, setSucheBuchID } from '../_index';
import { useState } from "react";

export default function SearchButtonHeader({ searchText }) {

  const [valueAlleBuecher, setValueAlleBuecher] = useState(getSucheAlleBuecher)
